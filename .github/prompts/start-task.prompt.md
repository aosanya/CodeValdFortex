...
> ⚠️ **Before starting a new task**, run `CodeValdFortex/.github/prompts/finish-task.prompt.md` to ensure any in-progress task is properly completed and merged first.
